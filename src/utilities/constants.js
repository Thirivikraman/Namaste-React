...
export const SWIGGY_Menu_API = "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=11.6631865&lng=78.1446849&restaurantId="


//Named import and export is used when we want to import/export multiple items from one file to another
//Default export is used if only one item needs to be imported/exported